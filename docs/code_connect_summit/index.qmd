...
<section id="speakers" class="ccs-section">
  ...
  <div class="ccs-speakers-grid" id="speakersGrid">
    ...
    <div class="ccs-speaker-card" role="button" tabindex="0" aria-expanded="false" onclick="expandSpeaker(this)" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();expandSpeaker(this)}">
      <div class="ccs-speaker-front">
        <div class="ccs-speaker-avatar"><img src="images/Speaker - Massimo.png" alt="Massimo"></div>
        <div class="ccs-speaker-name">Massimo</div>
        <div class="ccs-speaker-talk">LLM in Document Understanding</div>
      </div>
      <div class="ccs-speaker-detail">
        <div class="ccs-speaker-photo"><img src="images/Speaker - Massimo.png" alt="Massimo"></div>
        <div>
          <div class="ccs-speaker-bio-name">Massimo</div>
          <div class="ccs-speaker-bio-talk">LLM in Document Understanding</div>
          <div class="ccs-speaker-bio-text">Bio coming soon.</div>
        </div>
      </div>
    ...
    <div class="ccs-speaker-card" role="button" tabindex="0" aria-expanded="false" onclick="expandSpeaker(this)" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();expandSpeaker(this)}">
      <div class="ccs-speaker-front">
        <div class="ccs-speaker-avatar"><img src="images/Speaker - Nick.png" alt="Nick Driver"></div>
        <div class="ccs-speaker-name">Nick Driver</div>
        <div class="ccs-speaker-talk">Self-Healing Codebases</div>
      </div>
      <div class="ccs-speaker-detail">
        <div class="ccs-speaker-photo"><img src="images/Speaker - Nick.png" alt="Nick Driver"></div>
        <div>
